    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PublicShareLinks", x => x.ShareLinkId);
                    table.ForeignKey(
                        name: "FK_PublicShareLinks_Files_FileId",
                        column: x => x.FileId,
                        principalTable: "Files",
                        principalColumn: "FileId");
                    table.ForeignKey(
                        name: "FK_PublicShareLinks_Folders_FolderId",
                        column: x => x.FolderId,
                        principalTable: "Folders",
                        principalColumn: "FolderId");
                    table.ForeignKey(
                        name: "FK_PublicShareLinks_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Folders_Name_ParentFolderId_UserId",
                table: "Folders",
                columns: new[] { "Name", "ParentFolderId", "UserId" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PublicShareLinks_FileId",
                table: "PublicShareLinks",
                column: "FileId");

            migrationBuilder.CreateIndex(
                name: "IX_PublicShareLinks_FolderId",
                table: "PublicShareLinks",
                column: "FolderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PublicShareLinks_UserId",
                table: "PublicShareLinks",
                column: "UserId");
